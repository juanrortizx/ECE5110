...
\vspace{0.1in}
\begin{center}
\includegraphics[width=0.7\linewidth]{../results/article_images/summary_table.png}
\captionof{figure}{Per-method differentiation summary reused from generated Unit 03 artifacts.}
\end{center}
\contentend
...
\begin{itemize}
    ...
    \item Simpson observed order: $6.19026$ (expected $4$; inflated by near-zero terminal errors).
